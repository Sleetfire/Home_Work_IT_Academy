Нумерация в README.txt идет как в условии домашнего задания.

[2] Работа с коллекциями:
	Реализация заданий [2.1] и [2.2] представлена в классе WorkWithCollections и в пакете
	runners в классе CollectionsMain.
